...
public class GameObject extends BasicObject {
    ...
    private var hpBarLineStyle_:GraphicsStroke = null;
    ...
    public function GameObject(_arg1:XML) {
        ...
        hasShadow_ = true; //(this.props_.shadowSize_ > 0);
        ...
        if (_arg1.hasOwnProperty("Defense")) {
            this.defense_ = int((_arg1.Defense)).toString();
        }
    ...
    public function setNewSize(size:int):void {
        this.size_ = size;
        if (this is Player)
            this.clearCache();
    }
    ...
    override public function draw(graphicsData:Vector.<IGraphicsData>, camera:Camera, time:int):void {
        ...
        var _local9:uint;
        var _local10:uint;
        var _local4:BitmapData = this.getTexture(camera, time);
        ...
        if (((!((this.obj3D_ == null))) && (!(Parameters.isGpuRender())))) {
            this.obj3D_.draw(graphicsData, camera, this.props_.color_, _local4);
            return;
        }
        if (((!((this.obj3D_ == null))) && (Parameters.isGpuRender()))) {
        ...
        if (this.flash_ != null) {
            if (!this.flash_.doneAt(time)) {
                if (Parameters.isGpuRender()) {
                    this.flash_.applyGPUTextureColorTransform(_local4, time);
                }
                else {
                    _local4 = this.flash_.apply(_local4, time);
                }
            }
            else {
                this.flash_ = null;
        ...
        if (((((((!(this.isPaused())) && (((this.condition_[ConditionEffect.CE_FIRST_BATCH]) || (this.condition_[ConditionEffect.CE_SECOND_BATCH]))))) && (!(Parameters.screenShotMode_)))) && (!((this is Pet))))) {
            this.drawConditionIcons(graphicsData, time);
        }
    ...
    public function drawConditionIcons(graphicsData:Vector.<IGraphicsData>, time:int):void {
        ...
        while (_local8 < _local7) {
            ...
            var _local15:Vector.<Number> = _local11.data;
            _local15.push(
                    _local12,
                    _local13,
            ...
            _local11.data = _local15;
            _local14 = _local10.matrix;
            _local14.identity();
            _local14.translate(_local12, _local13);
            graphicsData.push(_local10);
            graphicsData.push(_local11);
            graphicsData.push(GraphicsUtil.END_FILL);
            _local8++;
        }
    }
    ...
    override public function drawShadow(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void {
        if (this.shadowGradientFill_ == null) {
            this.shadowGradientFill_ = new GraphicsGradientFill(GradientType.RADIAL, [this.props_.shadowColor_, this.props_.shadowColor_, this.props_.shadowColor_, this.props_.shadowColor_, this.props_.shadowColor_], [0.75, 0.75, 0.75, 0.125, 0], null, new Matrix());
            this.shadowPath_ = new GraphicsPath(GraphicsUtil.QUAD_COMMANDS, new Vector.<Number>());
        }
        var adjust:Number = 0.75;
        var _local4:Number = (((this.size_ / 100) * (this.props_.shadowSize_ / 100)) * this.sizeMult_) * adjust;
        var _local5:Number = (45 * _local4);
        var _local6:Number = (30 * _local4);
