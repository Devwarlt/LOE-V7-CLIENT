...
public class Merchant extends SellableObject implements IInteractiveObject {
    ...
    override public function getIcon():BitmapData {
        ...
        if (_local2.hasOwnProperty("Doses") || _local2.hasOwnProperty("@successChance")) {
            ...
            _local3 = new BaseSimpleText(12, _isSuccessChance ? _successChanceColor : 0xFFFFFF, false, 0, 0);
            _local3.text = _isSuccessChance ? _successChance : String(_local2.Doses);
            _local3.setBold(_isSuccessChance);
