...
public class Projectile extends BasicObject {
    ...
    override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void {
        ...
        if (Parameters.projColorType_ != 0) {
            ...
            _local4 = TextureRedrawer.redraw(_local4, 120, true, _local1);
        }
        ...
        if (this.projProps_.particleTrail_) {
            _local2 = (((this.projProps_.particleTrailLifetimeMS) != -1) ? this.projProps_.particleTrailLifetimeMS : 600);
            _local3 = 0;
            for (; _local3 < 3; _local3++) {
                ...
                map_.addObj(new SparkParticle(100, this.projProps_.particleTrailColor_, _local2, 0.5, RandomUtil.plusMinus(3), RandomUtil.plusMinus(3)), x_, y_);
            }
        }
    }
