...
public class CharacterSelectionAndNewsScreen extends Sprite {
    ...
    private function createNameText(_arg1:PlayerModel):void {
        ...
        this.nameText.y = !_arg1.isNameChosen() ? 4 : 24;
    ...
    private var accountInfoBtn_:DynamicButton = new DynamicButton(16, "Account Info", new EmbeddedAssets_buttonNormal_shapeEmbed_().bitmapData, new EmbeddedAssets_buttonHover_shapeEmbed_().bitmapData);
    private var gameStoreBtn_:DynamicButton = new DynamicButton(16, "Game Store", new EmbeddedAssets_buttonNormal_shapeEmbed_().bitmapData, new EmbeddedAssets_buttonHover_shapeEmbed_().bitmapData);

    private function drawExtraButtons():void {
        this.accountInfoBtn_.x = stage.stageWidth - this.accountInfoBtn_.width - 18;
        this.accountInfoBtn_.y = 56;
        this.accountInfoBtn_.addEventListener(MouseEvent.CLICK, this.beginAccountInfoRequest);
        addChild(this.accountInfoBtn_);

        this.gameStoreBtn_.x = stage.stageWidth - 2 * this.gameStoreBtn_.width - 18 - 8;
        this.gameStoreBtn_.y = 56;
        this.gameStoreBtn_.addEventListener(MouseEvent.CLICK, this.beginGameStoreRequest);
        addChild(this.gameStoreBtn_);
    }

    private function beginAccountInfoRequest(_arg1:MouseEvent):void {
        addChild(new AccountInformationWindow());
    }

    private function beginGameStoreRequest(_arg1:MouseEvent):void {
        addChild(new GameStoreWindow());
    }
}
}