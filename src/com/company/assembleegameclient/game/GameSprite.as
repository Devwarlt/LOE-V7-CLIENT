...
import kabam.rotmg.game.view.DiscordModalButton;
...
public class GameSprite extends AGameSprite {
    ...
    public const sendPlayerData:Signal = new Signal(Player);
    ...
    public var discordModalButton:DiscordModalButton;
    ...
    private function showDiscordIcon():void {
        this.discordModalButton = new DiscordModalButton();
        this.discordModalButton.x = 6;
        this.discordModalButton.y = (this.displaysPosY + 2);
        this.displaysPosY = (this.displaysPosY + UIUtils.NOTIFICATION_SPACE);
        addChild(this.discordModalButton);
    }
    ...
    private function showRankText2():void {
        this.rankText2_ = new RankText(-1, true, false, true);
        this.rankText2_.x = 594;
        this.rankText2_.y = this.rankText_.y + 8;
        addChild(this.rankText2_);
    }
    ...
    private function onEnterFrame(_arg1:Event):void {
        try {
            ...
            if (_local5 != null) {
                ...
                this.sendPlayerData.dispatch(_local5);
            }
            lastUpdate_ = _local2;
