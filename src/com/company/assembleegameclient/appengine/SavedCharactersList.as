...
public class SavedCharactersList extends Event {
    ...
    private function parseUserData(_arg1:XML):void {
        this.empiresCoin_ = int(_arg1.EmpiresCoin);
        ...
        this.accountType_ = int(_arg1.AccountType);
        Player.isAdmin = this.isAdmin_;
        Player.accountType_ = this.accountType_;
        Player.empiresCoin_ = this.empiresCoin_;
        ...
        this.menuMusic_ = "main";
        this.deadMusic_ = "death_screen_v2";
    }
