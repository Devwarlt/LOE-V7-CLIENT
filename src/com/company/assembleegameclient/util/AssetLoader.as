...
public class AssetLoader {
    ...
    private function addAnimatedCharacters():void {
        AnimatedChars.add("LRPets8x8", new EmbeddedAssets.LoERealmPets8x8Embed_().bitmapData, null, 8, 8, 56, 8, AnimatedChar.DOWN);
        AnimatedChars.add("LRPets16x16", new EmbeddedAssets.LoERealmPets16x16Embed_().bitmapData, null, 16, 16, 112, 16, AnimatedChar.DOWN);
        ...
        AnimatedChars.add("LRES8x8", new EmbeddedAssets.LoERealmEditionsSkins8x8Embed_().bitmapData, null, 8, 8, 56, 8, AnimatedChar.DOWN);
