...
public class PlayerToolTip extends ToolTip {
    ...
    public function PlayerToolTip(_arg1:Player) {
        ...
        _local2 = (_local2 + 30); // +44 (+30 default)
        ...
        this.hpBar_.x = this.hpBarBackground_.x = 6;
        this.hpBar_.y = this.hpBarBackground_.y = _local2;
        ...
        this.mpBar_.x = this.mpBarBackground_.x = 6;
        this.mpBar_.y = this.mpBarBackground_.y = _local2;
