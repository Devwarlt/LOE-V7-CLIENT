...
public class EquipmentToolTip extends ToolTip {
    ...
    public function EquipmentToolTip(objectType:int, player:Player, inventoryType:int, inventoryOwnerType:String) {
        ...
        var _local5:int = ((player) ? ObjectLibrary.getMatchingSlotIndex(this.objectType, player) : -1);
        var _local6:uint = ((((this.playerCanUse) || ((this.player == null)))) ? 0x363636 : 6036765);
        var _local7:uint = ((((this.playerCanUse) || ((player == null)))) ? 0x9B9B9B : 10965039);
    ...
    private function addIcon():void {
        ...
        var _local3:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this.objectType, this.iconSize, true, true, _local2);
    ...
    private function addMpCostTagToEffectsList():void {
        if (this.objectXML.hasOwnProperty("MpEndCost")) {
            ...
            if (((this.objectXML.hasOwnProperty(TextKey.MPCOST)) && (!(this.comparisonResults.processedTags[this.objectXML.MpCost[0].toXMLString()])))) {
    ...
    private function handleWisMod():void {
        ...
        var _local1:Number = (Parameters.parse(this.player.wisdom_) + Parameters.parse(this.player.wisdomBoost_));
        if (_local1 < 30) {
            return;
        }
    ...
    private function modifyWisModStat(_arg1:String, _arg2:Number = 1):String {
        ...
        var _local4:Number = (Parameters.parse(this.player.wisdom_) + Parameters.parse(this.player.wisdomBoost_));
        if (_local4 < 30) {
            _local3 = _arg1;
        }
        else {
