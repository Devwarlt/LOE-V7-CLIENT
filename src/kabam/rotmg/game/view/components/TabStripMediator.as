...
import kabam.rotmg.pets.view.components.NewPetsTabContentView;
...
public class TabStripMediator extends Mediator {
    ...
    private function addTabs(_arg1:Player):void {
        ...
        this.view.addTab(this.iconFactory.makeIconBitmap(TabConstants.PETS_ICON_ID), new NewPetsTabContentView(_arg1));
    }
