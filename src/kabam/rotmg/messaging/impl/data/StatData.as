...
public class StatData {
    ...
    public static const ACCOUNT_TYPE:int = 98;
    public static const ADMIN:int = 99;
    public static const PET_OBJECT_ID:int = 100;
    public static const PET_HP_HEALING_AVERAGE_MIN:int = 101;
    public static const PET_HP_HEALING_AVERAGE_MAX:int = 102;
    public static const PET_HP_HEALING_AVERAGE_BONUS:int = 103;
    public static const PET_MP_HEALING_AVERAGE_MIN:int = 104;
    public static const PET_MP_HEALING_AVERAGE_MAX:int = 105;
    public static const PET_MP_HEALING_AVERAGE_BONUS:int = 106;
    public static const PET_ATTACK_COOLDOWN:int = 107;
    ...
    public static const CHAR_ARM:int = 125;
    public static const CHAR_ATTACK:int = 126;
    public static const CHAR_DEFENSE:int = 127;
    public static const INVENTORY_0_STAT:int = 128;
    public static const INVENTORY_1_STAT:int = 129;
    public static const INVENTORY_2_STAT:int = 130;
    public static const INVENTORY_3_STAT:int = 131;
    public static const INVENTORY_4_STAT:int = 132;
    public static const INVENTORY_5_STAT:int = 133;
    public static const INVENTORY_6_STAT:int = 134;
    public static const INVENTORY_7_STAT:int = 135;
    public static const INVENTORY_8_STAT:int = 136;
    public static const INVENTORY_9_STAT:int = 137;
    public static const INVENTORY_10_STAT:int = 138;
    public static const INVENTORY_11_STAT:int = 139;
    public static const INVENTORY_12_STAT:int = 140;
    public static const INVENTORY_13_STAT:int = 141;
    public static const INVENTORY_14_STAT:int = 142;
    public static const INVENTORY_15_STAT:int = 143;
    public static const INVENTORY_16_STAT:int = 144;
    public static const INVENTORY_17_STAT:int = 145;
    public static const INVENTORY_18_STAT:int = 146;
    public static const INVENTORY_19_STAT:int = 147;
    public static const INVENTORY_20_STAT:int = 148;
    public static const INVENTORY_21_STAT:int = 149;
    public static const INVENTORY_22_STAT:int = 150;
    public static const INVENTORY_23_STAT:int = 151;
    public static const INVENTORY_24_STAT:int = 152;
    public static const INVENTORY_25_STAT:int = 153;
    public static const INVENTORY_26_STAT:int = 154;
