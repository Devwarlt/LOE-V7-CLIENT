...
public class DomainModel {
    ...
    private const LOESOFT_WHITELIST:Array = ["testing.loesoft.org", "loesoft.org"];
    private const WHITELIST:Array = PRODUCTION_WHITELIST.concat(TESTING_WHITELIST).concat(TRANSLATION_WHITELIST).concat(TESTING2_WHITELIST).concat(LOESOFT_WHITELIST);
