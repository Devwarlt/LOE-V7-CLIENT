...
public class FortuneModal extends EmptyFrame {
    ...
    public function FortuneModal(_arg1:GameSprite = null) {
        ...
        this.creditDisplay_ = new CreditDisplay(null, false);
        ...
        if (_local3 != null) {
            this.creditDisplay_.draw(_local3.credits_, 0);
        }
        if (_arg1 != null) {
            this.gs_ = _arg1;
    ...
    private function onItemSwitch(_arg1:TimerEvent = null):void {
        ...
        if (((!((this.creditDisplay_ == null))) && (!((_local4 == null))))) {
            this.creditDisplay_.draw(_local4.credits_, 0);
        }
    }
        ...
        if ((((this.state == STATE_ROUND_1)) && (!(this.client.requestInProgress())))) {
            ...
            if (_local2 != null) {
                if (this.boughtWithGold) {
                    ...
                    this.creditDisplay_.draw(_local2.credits_, 0);
                }
                else {
